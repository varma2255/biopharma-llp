...
//       style={{ borderBottom: "1px solid #e8edf5", boxShadow: "0 2px 16px rgba(0,0,0,0.08)" }}
//     >
//       <div className="max-w-7xl mx-auto px-3 sm:px-5 lg:px-8 flex items-center h-[64px] sm:h-[72px] lg:h-[80px]">

//         {/* ── Logo ── */}
//         <Link
//           href="/"
//           className="flex items-center gap-2 md:gap-3 shrink-0 mr-3 sm:mr-6 lg:mr-10 min-w-0"
//         >
//           <img
//             src="/images/logo.jpeg"
//             alt="Logo"
//             className="w-10 h-10 sm:w-12 sm:h-12 lg:w-16 lg:h-16 shrink-0"
//             style={{ objectFit: "contain", borderRadius: 10 }}
//           />
//           <div style={{ display: "flex", flexDirection: "column", lineHeight: 1.25 }} className="min-w-0">
//             <span
//               className="truncate"
//               style={{
//                 color: "#2A5DA8",
...
//               style={{ fontSize: "clamp(9px, 1vw, 11px)", color: "#9ca3af", letterSpacing: "0.5px", marginTop: 2 }}
//             >
//               Solution to Aquaculture Health....
//             </span>
//           </div>
...
//         {/* ── Desktop nav links ── */}
//         <div className="hidden lg:flex items-center flex-1 gap-0.5 xl:gap-1">
//           {navLinks.map((link) => (
//             <div
//               key={link.label}
//               className="relative"
...
//                 <button
//                   onClick={() => link.href && router.push(link.href)}
//                   className="flex items-center gap-0.5 px-2 xl:px-3 py-2 transition-colors whitespace-nowrap"
//                   style={{ fontSize: "clamp(10px, 0.85vw, 12px)", fontWeight: 600, color: "#6b7280", letterSpacing: "0.4px", background: "none", border: "none", cursor: "pointer" }}
//                   onMouseEnter={e => (e.currentTarget.style.color = "#2A5DA8")}
//                   onMouseLeave={e => (e.currentTarget.style.color = "#6b7280")}
//                 >
//                   {link.label}
...
//                 <Link
//                   href={link.href!}
//                   className="flex items-center px-2 xl:px-3 py-2 transition-colors whitespace-nowrap"
//                   style={{ fontSize: "clamp(10px, 0.85vw, 12px)", fontWeight: 600, color: "#6b7280", letterSpacing: "0.4px" }}
//                   onMouseEnter={e => ((e.currentTarget as HTMLElement).style.color = "#2A5DA8")}
//                   onMouseLeave={e => ((e.currentTarget as HTMLElement).style.color = "#6b7280")}
//                 >
//                   {link.label}
...
//                     <div style={{
//                       background: "#fff", border: "1px solid #e8edf5", borderRadius: 14,
//                       padding: "6px 0", minWidth: "clamp(200px, 16vw, 220px)",
//                       boxShadow: "0 20px 60px rgba(0,0,0,0.13)",
//                     }}>
//                       {(link.dropdown as any[]).map((item) => (
//                         <Link key={item.name} href={item.link} onClick={() => setOpenDropdown(null)}
...
//         {/* ── Cart button — far right (desktop) ── */}
//         <div className="hidden lg:flex items-center ml-3 xl:ml-6 shrink-0">
//           <Link
//             href="/cart"
//             style={{
//               position: "relative",
...
//           </Link>
//         </div>
//         {/* ── Mobile/tablet: cart + hamburger (shown below lg breakpoint) ── */}
//         <div className="lg:hidden flex items-center gap-1.5 sm:gap-2 ml-auto shrink-0">
//           <Link
//             href="/cart"
//             style={{
//               position: "relative", display: "flex", alignItems: "center", gap: 6,
//               padding: "clamp(6px, 1.8vw, 7px) clamp(10px, 3vw, 14px)", borderRadius: 999,
//               background: cartActive ? "#2A5DA8" : "#fff",
//               border: cartActive ? "1.5px solid #2A5DA8" : "1.5px solid #e2e8f0",
//               textDecoration: "none",
//               boxShadow: cartActive ? "0 4px 14px rgba(42,93,168,0.3)" : "0 1px 4px rgba(0,0,0,0.06)",
...
//             }}
//           >
//             <span style={{ fontSize: "clamp(13px, 3.5vw, 15px)" }}>🛒</span>
//             <span style={{ fontSize: "clamp(11px, 3vw, 12px)", fontWeight: 700, color: cartActive ? "#fff" : "#374151" }}>Cart</span>
//             {totalCartQty > 0 && (
//               <span style={{
//                 position: "absolute", top: -7, right: -7,
//                 minWidth: 18, height: 18,
...
//       {/* ── Mobile/tablet menu (below lg breakpoint) ── */}
//       {mobileOpen && (
//         <div style={{ background: "#fff", borderTop: "1px solid #f0f0f0", padding: "8px 16px 20px", boxShadow: "0 8px 24px rgba(0,0,0,0.08)" }} className="sm:px-5">
//           <div style={{ display: "flex", flexDirection: "column" }}>
//             {navLinks.map((link, idx) => (
//               <div key={link.label} style={{ borderBottom: idx < navLinks.length - 1 ? "1px solid #f5f5f5" : "none" }}>
//                 {link.dropdown ? (
...
export default function Navbar() {
  ...
  return (
    <nav
      className="w-full bg-white fixed top-0 z-50 overflow-x-clip"
      style={{ borderBottom: "1px solid #e8edf5", boxShadow: "0 2px 16px rgba(0,0,0,0.08)" }}
    >
      <div className="max-w-7xl mx-auto px-3 sm:px-5 lg:px-8 flex items-center justify-between h-16 sm:h-[72px] lg:h-20">

        {/* ── Logo ── */}
        <Link
          href="/"
          className="flex items-center gap-2 sm:gap-2.5 lg:gap-3 shrink-0 min-w-0"
        >
          <img
            src="/images/logo.jpeg"
            alt="Logo"
            className="w-9 h-9 sm:w-11 sm:h-11 lg:w-14 lg:h-14 shrink-0 rounded-[10px] object-contain"
          />
          <div className="flex flex-col leading-tight min-w-0">
            <span
              className="truncate max-w-[130px] sm:max-w-[220px] md:max-w-[260px] lg:max-w-[300px] text-[12px] sm:text-[15px] lg:text-[18px] font-bold"
              style={{ color: "#2A5DA8", letterSpacing: "-0.3px" }}
            >
              Innovare Biopharma LLP
            </span>
            <span
              className="hidden sm:block truncate text-[9px] lg:text-[11px] mt-0.5"
        ...
        {/* ── Desktop nav links ── */}
        <div className="hidden lg:flex items-center flex-1 justify-center gap-0.5 xl:gap-1 min-w-0 px-2">
          {navLinks.map((link) => (
            <div
              key={link.label}
              className="relative"
            ...
            >
              {link.dropdown ? (
                <button
                  onClick={() => link.href && router.push(link.href)}
                  className="flex items-center gap-0.5 px-2 xl:px-3 py-2 transition-colors whitespace-nowrap text-[11px] xl:text-[12px] font-semibold"
                  style={{ color: "#6b7280", letterSpacing: "0.4px", background: "none", border: "none", cursor: "pointer" }}
                  onMouseEnter={e => (e.currentTarget.style.color = "#2A5DA8")}
                  onMouseLeave={e => (e.currentTarget.style.color = "#6b7280")}
                >
                  {link.label}
                ...
                <Link
                  href={link.href!}
                  className="flex items-center px-2 xl:px-3 py-2 transition-colors whitespace-nowrap text-[11px] xl:text-[12px] font-semibold"
                  style={{ color: "#6b7280", letterSpacing: "0.4px" }}
                  onMouseEnter={e => ((e.currentTarget as HTMLElement).style.color = "#2A5DA8")}
                  onMouseLeave={e => ((e.currentTarget as HTMLElement).style.color = "#6b7280")}
                >
                  {link.label}
              ...
              {link.dropdown && openDropdown === link.label && (
                ...
                >
                  ...
                  {/* Solutions */}
                  {link.isSolutions ? (
                    <div className="bg-white border rounded-2xl py-1.5 w-56" style={{ borderColor: "#e8edf5", boxShadow: "0 20px 60px rgba(0,0,0,0.13)" }}>
                      {(link.dropdown as any[]).map((item) => (
                        <Link key={item.name} href={item.link} onClick={() => setOpenDropdown(null)}
                          className="flex items-center gap-3 px-[18px] py-[11px] no-underline transition-colors"
                          onMouseEnter={e => { (e.currentTarget as HTMLElement).style.background = "#eff6ff"; }}
                          onMouseLeave={e => { (e.currentTarget as HTMLElement).style.background = "transparent"; }}
                        >
                          <span className="text-[15px] w-[22px] text-center">{item.icon}</span>
                          <span className="text-[13px] font-semibold" style={{ color: "#475569" }}>{item.name}</span>
                        </Link>
                      ))}
                    </div>
                    ...
                    <div className="bg-white border rounded-2xl py-1.5 w-56" style={{ borderColor: "#e8edf5", boxShadow: "0 20px 60px rgba(0,0,0,0.13)" }}>
                      ...
                      <div className="border-t mt-1" style={{ borderColor: "#f0f0f0" }}>
                        <Link href="/products" onClick={() => setOpenDropdown(null)}
                          className="block px-[18px] py-[11px] text-xs font-medium no-underline transition-colors"
                          style={{ color: "#94a3b8" }}
                          onMouseEnter={e => ((e.currentTarget as HTMLElement).style.color = "#2A5DA8")}
                          onMouseLeave={e => ((e.currentTarget as HTMLElement).style.color = "#94a3b8")}
                        >
                    ...
                    <div className="bg-white border rounded-2xl py-1.5 w-56" style={{ borderColor: "#e8edf5", boxShadow: "0 20px 60px rgba(0,0,0,0.13)" }}>
                      {(link.dropdown as any[]).map((item) => (
                        <Link key={item.name} href={item.link} onClick={() => setOpenDropdown(null)}
                          ...
                          onMouseLeave={e => { (e.currentTarget as HTMLElement).style.background = "transparent"; }}
                        >
                          {item.icon && <span className="text-[15px] w-[22px] text-center">{item.icon}</span>}
                          <span className="text-[13px] font-semibold" style={{ color: "#475569" }}>{item.name}</span>
                        </Link>
                      ))}
                    </div>
        ...
        <div className="hidden lg:flex items-center shrink-0">
          <Link
            href="/cart"
            className="relative flex items-center gap-2 rounded-full px-5 xl:px-6 py-2.5 whitespace-nowrap no-underline transition-all duration-300"
            style={{
              background:
                totalCartQty > 0
                  ? "linear-gradient(135deg, #ff7f7f 0%, #ff474c 100%)"
          ...
          >
            <span className="text-base" style={{ color: totalCartQty > 0 ? "#ffffff" : "#000000" }}>
              🛒
            </span>
            <span className="text-sm font-bold" style={{ letterSpacing: ".2px", color: totalCartQty > 0 ? "#ffffff" : "#000000" }}>
              Cart
            </span>

            {totalCartQty > 0 && (
              <span
                className="absolute -top-2 -right-2 min-w-[24px] h-6 flex items-center justify-center rounded-full px-1.5 text-[11px] font-extrabold"
                style={{
                  background: "#fff",
                  color: "#ff474c",
                  border: "2px solid #ff474c",
        ...
        <div className="lg:hidden flex items-center gap-2 shrink-0">
          <Link
            href="/cart"
            className="relative flex items-center gap-1.5 rounded-full px-3 py-2 whitespace-nowrap no-underline transition-all duration-200"
            style={{
              background: cartActive ? "#2A5DA8" : "#fff",
              border: cartActive ? "1.5px solid #2A5DA8" : "1.5px solid #e2e8f0",
              boxShadow: cartActive ? "0 4px 14px rgba(42,93,168,0.3)" : "0 1px 4px rgba(0,0,0,0.06)",
          ...
          >
            ...
            <span className="text-[12px] font-bold" style={{ color: cartActive ? "#fff" : "#374151" }}>Cart</span>
            {totalCartQty > 0 && (
              <span className="absolute -top-1.5 -right-1.5 min-w-[18px] h-[18px] flex items-center justify-center rounded-full px-1 text-[10px] font-extrabold text-white" style={{ background: "#ef4444", border: "2px solid #fff" }}>
                {totalCartQty}
              </span>
            )}
          </Link>
      ...
      {mobileOpen && (
        <div
          className="lg:hidden bg-white border-t px-4 sm:px-5 pt-2 pb-5 overflow-y-auto"
          style={{ borderColor: "#f0f0f0", boxShadow: "0 8px 24px rgba(0,0,0,0.08)", maxHeight: "calc(100vh - 64px)" }}
        >
          <div className="flex flex-col">
            {navLinks.map((link, idx) => (
              <div key={link.label} className="border-b" style={{ borderColor: idx < navLinks.length - 1 ? "#f5f5f5" : "transparent" }}>
                {link.dropdown ? (
                  <>
                    <button
                      onClick={() => setOpenDropdown(openDropdown === link.label ? null : link.label)}
                      className="w-full flex justify-between items-center py-3 bg-transparent border-none cursor-pointer text-[12px] font-semibold"
                      style={{ color: "#374151", letterSpacing: "0.4px" }}
                    >
                      {link.label}
                      <ChevronDown size={14} style={{ transform: openDropdown === link.label ? "rotate(180deg)" : "none", transition: "transform .2s" }} />
                    </button>
                      ...
                      <div className="pb-2.5">
                        {link.isSolutions ? (
                          <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                            {(link.dropdown as any[]).map(item => (
                              <Link key={item.name} href={item.link} onClick={() => { setMobileOpen(false); setOpenDropdown(null); }}
                                className="flex flex-col items-center py-3 px-2 rounded-[10px] no-underline border"
                                style={{ borderColor: "#f0f0f0", background: "#fafafa" }}
                              >
                                <span className="text-xl mb-1.5">{item.icon}</span>
                                <p className="text-[11px] font-semibold text-center" style={{ color: "#1e293b" }}>{item.name}</p>
                              </Link>
                            ))}
                          </div>
                        ) : link.isProducts ? (
                            ...
                            {productDomains.map(item => (
                              ...
                              >
                                ...
                                <div className="min-w-0">
                                  <p className="text-[13px] font-semibold truncate" style={{ color: "#1e293b" }}>{item.name}</p>
                                  <p className="text-[10px]" style={{ color: "#94a3b8" }}>{item.count}</p>
                                </div>
                              </Link>
                            ))}
                          </div>
                          ...
                          <div className="flex flex-col gap-0.5">
                            {(link.dropdown as any[]).map(item => (
                              <Link key={item.name} href={item.link} onClick={() => { setMobileOpen(false); setOpenDropdown(null); }}
                                ...
                                onMouseLeave={e => ((e.currentTarget as HTMLElement).style.background = "transparent")}
                              >
                                {item.icon && <span className="text-[15px] shrink-0">{item.icon}</span>}
                                <span className="text-[13px] font-semibold truncate" style={{ color: "#475569" }}>{item.name}</span>
                              </Link>
                            ))}
                          </div>
                        )}
                  ...
                  <Link href={link.href!} onClick={() => setMobileOpen(false)}
                    className="block py-3 text-[12px] font-semibold no-underline"
                    style={{ color: "#374151", letterSpacing: "0.4px" }}
                  >
                    {link.label}
                  </Link>
